            ...
            <label className={styles.label} for="arcade">
              <div className={styles.card_img}>
                <img
                  ...
                  width="35"
                  height="35"
                  src="https://img.icons8.com/external-smashingstocks-circular-smashing-stocks/65/external-arcade-technology-and-hardware-smashingstocks-circular-smashing-stocks.png"
                  alt="external-arcade-technology-and-hardware-smashingstocks-circular-smashing-stocks"
                />
            ...
            <label className={styles.label} for="advanced">
              <div className={styles.card_img}>
                <img
                  ...
                  width="35"
                  height="35"
                  src="https://img.icons8.com/fluency/48/controller.png"
                  alt="controller"
                />
            ...
            <label className={styles.label} for="pro">
              <div className={styles.card_img}>
                <img
                  ...
                  width="35"
                  height="35"
                  src="https://img.icons8.com/material-two-tone/24/controller.png"
                  alt="controller"
                />
